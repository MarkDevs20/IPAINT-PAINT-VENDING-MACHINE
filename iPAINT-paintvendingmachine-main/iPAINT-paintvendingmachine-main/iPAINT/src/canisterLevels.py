...
offlinePaintFile = os.path.join(offlineFolder, "your own json file")
...
def initializeFirebase():
    ...
    if firebaseSync:
        return
    try:
        cred = credentials.Certificate(r'your own database path')
        firebase_admin.initialize_app(cred, {'databaseURL': ' your own database url'})
        firebaseSync = True
