...
try:
    ...
    orderCred = credentials.Certificate(r'iPAINT/credentials/ipaintorderhistory-firebase-adminsdk-fbsvc-e00b549125.json')
    app = firebase_admin.initialize_app(orderCred, {'databaseURL':'https://ipaintorderhistory-default-rtdb.asia-southeast1.firebasedatabase.app/OrderHistory'}, name='orderApp')
